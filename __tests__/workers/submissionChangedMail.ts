...
import worker from '../../src/workers/submissionChangedMail';
...
it('should send mail when the submission status is statrted', async () => {
...
it('should not send mail when the submission status is accepted', async () => {
  const mockedUsers: GatewayUser[] = [
    {
      id: '1',
      email: 'lee@acme.com',
