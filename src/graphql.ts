...
import * as contributionEligibilityDirective from './directive/contributionEligibility';
...
import * as contributions from './schema/contributions';
...
export const schema = urlDirective.transformer(
  feedPlusDirective.transformer(
    rateLimitCounterDirective.transformer(
      contributionEligibilityDirective.transformer(
          ...
          rateLimiterTransformers(
            makeExecutableSchema({
              typeDefs: [
                ...
                contributionEligibilityDirective.typeDefs,
                comments.typeDefs,
