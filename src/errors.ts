...
> = {
  ...
  AUTHOR_BANNED:
    'Unfortunately the article submitted is written by an creator who violated our community guidelines and is banned. We no longer accept submissions from this creator.',
  ACCESS_DENIED:
