...
export class UserSourceIntegration1720103113795 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_source_integration" ("userIntegrationId" uuid NOT NULL, "sourceId" text NOT NULL, "type" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "channelIds" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_b69cf89edca5369626b1dda8d79" PRIMARY KEY ("userIntegrationId", "sourceId"))`);
