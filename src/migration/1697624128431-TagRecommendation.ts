...
export class TagRecommendation1697624128431 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_keywordX_keywordY_probability" ON "tag_recommendation" ("keywordX", "keywordY", "probability") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_keywordX_keywordY_probability"`);
