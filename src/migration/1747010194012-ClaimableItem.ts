...
export class ClaimableItem1747010194012 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "claimable_item" ("id" character varying NOT NULL, "email" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "claimedAt" TIMESTAMP, "type" character varying NOT NULL, "flags" jsonb NOT NULL DEFAULT '{}', "claimedById" character varying, CONSTRAINT "PK_738cbf01fde094d0da43a1c2c80" PRIMARY KEY ("id"))`);
