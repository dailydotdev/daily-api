...
export class AddUserHotTakeUpvotes1769156534090 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question" DROP CONSTRAINT "FK_question_screening_opportunity_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "dataset_location" DROP CONSTRAINT "CHK_dataset_location_country_or_continent"`);
        await queryRunner.query(`CREATE TABLE "user_hot_take_upvote" ("hotTakeId" uuid NOT NULL, "userId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0fb6851f42e1d3f4138e3e4b8ca" PRIMARY KEY ("hotTakeId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_902a36de7917e47ab8839ae46f" ON "user_hot_take_upvote" ("hotTakeId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_cc451486cbf598411e27264102" ON "user_hot_take_upvote" ("userId", "createdAt") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_0fb6851f42e1d3f4138e3e4b8c" ON "user_hot_take_upvote" ("hotTakeId", "userId") `);
        await queryRunner.query(`ALTER TABLE "user_hot_take" ADD "upvotes" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "user_hot_take" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_hot_take" ADD "userId" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "user_stack" DROP CONSTRAINT "FK_user_stack_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_stack_user_id"`);
        await queryRunner.query(`ALTER TABLE "user_stack" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_stack" ADD "userId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" DROP CONSTRAINT "FK_user_workspace_photo_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_workspace_photo_user_id"`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" ADD "userId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_gear" DROP CONSTRAINT "FK_user_gear_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_gear_user_id"`);
        await queryRunner.query(`ALTER TABLE "user_gear" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_gear" ADD "userId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_tool" DROP CONSTRAINT "FK_user_tool_user_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_tool_user_id"`);
        await queryRunner.query(`ALTER TABLE "user_tool" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_tool" ADD "userId" character varying NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_user_hot_take_user_id" ON "user_hot_take" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c025478b45e60017ed10c77f99" ON "user_action" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_user_stack_user_id" ON "user_stack" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_user_workspace_photo_user_id" ON "user_workspace_photo" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_user_gear_user_id" ON "user_gear" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_user_tool_user_id" ON "user_tool" ("userId") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_hot_take" ADD CONSTRAINT "FK_user_hot_take_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_hot_take_upvote" ADD CONSTRAINT "FK_user_hot_take_upvote_hot_take_id" FOREIGN KEY ("hotTakeId") REFERENCES "user_hot_take"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_hot_take_upvote" ADD CONSTRAINT "FK_user_hot_take_upvote_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_stack" ADD CONSTRAINT "FK_user_stack_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" ADD CONSTRAINT "FK_user_workspace_photo_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_gear" ADD CONSTRAINT "FK_user_gear_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_tool" ADD CONSTRAINT "FK_user_tool_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_question_feedback_opportunity_id" FOREIGN KEY ("opportunityId") REFERENCES "opportunity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question" DROP CONSTRAINT "FK_question_feedback_opportunity_id"`);
        await queryRunner.query(`ALTER TABLE "organization" DROP CONSTRAINT "FK_organization_dataset_location_locationId"`);
        await queryRunner.query(`ALTER TABLE "notification_preference" DROP CONSTRAINT "FK_c8721bd56ae600308745ad49744"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_user_locationId"`);
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_ff0f49b797aca629f81cef47610"`);
        await queryRunner.query(`ALTER TABLE "user_hot_take_upvote" DROP CONSTRAINT "FK_user_hot_take_upvote_user_id"`);
        await queryRunner.query(`ALTER TABLE "user_hot_take_upvote" DROP CONSTRAINT "FK_user_hot_take_upvote_hot_take_id"`);
        await queryRunner.query(`ALTER TABLE "user_hot_take" DROP CONSTRAINT "FK_user_hot_take_user_id"`);
        await queryRunner.query(`ALTER TABLE "feed" DROP CONSTRAINT "FK_70952a3f1b3717e7021a439edda"`);
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "FK_e389fc192c59bdce0847ef9ef8b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_tool" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_tool" ADD "userId" text NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_user_tool_user_id" ON "user_tool" ("userId") `);
        await queryRunner.query(`ALTER TABLE "user_tool" ADD CONSTRAINT "FK_user_tool_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_gear" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_gear" ADD "userId" text NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_user_gear_user_id" ON "user_gear" ("userId") `);
        await queryRunner.query(`ALTER TABLE "user_gear" ADD CONSTRAINT "FK_user_gear_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" ADD "userId" text NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_user_workspace_photo_user_id" ON "user_workspace_photo" ("userId") `);
        await queryRunner.query(`ALTER TABLE "user_workspace_photo" ADD CONSTRAINT "FK_user_workspace_photo_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_stack" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_stack" ADD "userId" text NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_user_stack_user_id" ON "user_stack" ("userId") `);
        await queryRunner.query(`ALTER TABLE "user_stack" ADD CONSTRAINT "FK_user_stack_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_top_reader" ALTER COLUMN "id" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_top_reader" ALTER COLUMN "id" SET DEFAULT uuid_generate_v4()`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_ff0f49b797aca629f81cef47610" FOREIGN KEY ("defaultFeedId") REFERENCES "feed"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_hot_take" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "user_hot_take" ADD "userId" text NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_user_hot_take_user_id" ON "user_hot_take" ("userId") `);
        await queryRunner.query(`ALTER TABLE "user_hot_take" ADD CONSTRAINT "FK_user_hot_take_user_id" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "feed" DROP COLUMN "userId"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_hot_take" DROP COLUMN "upvotes"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0fb6851f42e1d3f4138e3e4b8c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cc451486cbf598411e27264102"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_902a36de7917e47ab8839ae46f"`);
        await queryRunner.query(`DROP TABLE "user_hot_take_upvote"`);
        await queryRunner.query(`ALTER TABLE "dataset_location" ADD CONSTRAINT "CHK_dataset_location_country_or_continent" CHECK (((country IS NOT NULL) OR (continent IS NOT NULL)))`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_question_screening_opportunity_id" FOREIGN KEY ("opportunityId") REFERENCES "opportunity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
