  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
          ...
          ('Readit!', 'Upvote 10 posts', 'https://daily-now-res.cloudinary.com/image/upload/v1770222920/achievements/readit.png', 'milestone', 'post_upvote', '{"targetCount": 10}', 10),
          ('Everyone gets an upvote!', 'Upvote 50 posts', 'https://daily-now-res.cloudinary.com/image/upload/v1770222884/achievements/Everyone_gets_an_upvote.png', 'milestone', 'post_upvote', '{"targetCount": 50}', 15),
          ('Upvote economy', 'Upvote 100 posts', 'https://daily-now-res.cloudinary.com/image/upload/v1770222941/achievements/Upvote_economy.png', 'milestone', 'post_upvote', '{"targetCount": 100}', 25),

          -- Comment upvote achievements (giving upvotes)
          ('Well said!', 'Upvote 10 comments', 'https://daily-now-res.cloudinary.com/image/upload/v1770222883/achievements/hello_there.png', 'milestone', 'comment_upvote', '{"targetCount": 10}', 10),
          ('User feedback', 'Upvote 50 comments', 'https://daily-now-res.cloudinary.com/image/upload/v1770222937/achievements/User_feedback.png', 'milestone', 'comment_upvote', '{"targetCount": 50}', 15),
          ...
          ('Hello, World!', 'Update your profile picture', 'https://daily-now-res.cloudinary.com/image/upload/v1770222916/achievements/Hello_World.png', 'instant', 'profile_image_update', '{"targetCount": 1}', 5),
          ('Cover art', 'Update your cover picture', 'https://daily-now-res.cloudinary.com/image/upload/v1770222884/achievements/Cover_art.png', 'instant', 'profile_cover_update', '{"targetCount": 1}', 5),
          ('Hello, is it me you''re looking for?', 'Update your profile location', 'https://daily-now-res.cloudinary.com/image/upload/v1770222884/achievements/Hello_is_it_me_you_re_looking_for.png', 'instant', 'profile_location_update', '{"targetCount": 1}', 5),
          ...
          ('Workaholic', 'Add a work experience', 'https://daily-now-res.cloudinary.com/image/upload/v1770222937/achievements/Workaholic.png', 'instant', 'experience_work', '{"targetCount": 1}', 5),
          ('Scholar', 'Add an education experience', 'https://daily-now-res.cloudinary.com/image/upload/v1770222917/achievements/Scholar.png', 'instant', 'experience_education', '{"targetCount": 1}', 5),
          ('Open Sourcerer', 'Add an open source experience', 'https://daily-now-res.cloudinary.com/image/upload/v1770222919/achievements/Open_Sourcerer.png', 'instant', 'experience_opensource', '{"targetCount": 1}', 5),
          ...
          ('The right tool for the job', 'Add 3 skills to your profile', 'https://daily-now-res.cloudinary.com/image/upload/v1770222932/achievements/The_right_tool_for_the_job.png', 'milestone', 'experience_skill', '{"targetCount": 3}', 10),
          ...
          -- Squad achievements
          ('Squad up', 'Join a squad', 'https://daily-now-res.cloudinary.com/image/upload/v1770222916/achievements/Squad_up.png', 'instant', 'squad_join', '{"targetCount": 1}', 5),
