...
export class Organization1746779368405 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."IDX_content_preference_organization_id"`);
    await queryRunner.query(`ALTER TABLE "content_preference" DROP CONSTRAINT "FK_bd1c701d7bd9a0eda2e434c7052"`);
