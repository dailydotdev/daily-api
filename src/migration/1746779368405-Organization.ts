...
export class Organization1746779368405 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_user_subflags_organizationid" ON "public"."user" (("subscriptionFlags"->>'organizationId'))`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_user_subflags_organizationid"`);
