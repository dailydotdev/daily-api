...
export class SourcePostModeration1730306548563 implements MigrationInterface {
  name = 'SourcePostModeration1730306548563';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "squad_post_moderation" ("id" text NOT NULL, "sourceId" text NOT NULL, "status" text NOT NULL, "createdById" character varying, "moderatedById" character varying, "moderatorMessage" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "postId" text, "type" text NOT NULL, "title" text, "titleHtml" text, "content" text, "contentHtml" text, "image" text, "sharedPostId" text, CONSTRAINT "PK_89a3c63bb8f2df10763ce5afe1a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
