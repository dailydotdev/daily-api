...
export class FeedAdvancedSettings1634725472930 implements MigrationInterface {
    name = 'FeedAdvancedSettings1634725472930'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."advanced_settings" ("id" text NOT NULL, "title" text NOT NULL, "description" text NOT NULL, "defaultDisabledState" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_dbd69e3f34b66d13d8772a2c4a0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_advancedSettings_id" ON "public"."advanced_settings" ("id") `);
        await queryRunner.query(`CREATE TABLE "public"."feed_advanced_settings" ("feedId" text NOT NULL, "advancedSettingsId" text NOT NULL, "disabled" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_3a8d7e5b1a44aff91cbe61b1e95" PRIMARY KEY ("feedId", "advancedSettingsId"))`);
