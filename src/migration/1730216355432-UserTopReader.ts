...
export class UserTopReader1730216355432 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "user_top_reader" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "issuedAt" timestamptz NOT NULL, "keywordValue" text NOT NULL, "image" text, CONSTRAINT "PK_32dd96f55e34926726b573b2840" PRIMARY KEY ("id", "userId"))`);
