...
export class Company1724144430626 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user_company" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "verified" boolean NOT NULL DEFAULT false, "email" text NOT NULL, "code" text NOT NULL, "userId" character varying NOT NULL, "companyId" text, CONSTRAINT "REL_9c279d6cf291c858efa8a6b143" UNIQUE ("companyId"), CONSTRAINT "PK_6576f99bbbc8080bb7ef40e5dbc" PRIMARY KEY ("email", "userId"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_313f10ed21d1916930351e3455" ON "user_company" ("email") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_user_company_code" ON "user_company" ("code") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_user_company_code"`);
    await queryRunner.query(
