...
export class MarketingCta1710235892939 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_marketing_cta" ("marketingCtaId" text NOT NULL, "userId" character varying(36) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "readAt" TIMESTAMP, "marketingCtaCampaignId" text, CONSTRAINT "PK_e4b378e49cd24e16b8cfa3a523d" PRIMARY KEY ("marketingCtaId", "userId"))`);
