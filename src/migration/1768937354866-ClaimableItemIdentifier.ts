...
export class ClaimableItemIdentifier1768937354866 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_claimable_item_identifier" ON "claimable_item" ("identifier") `,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_claimable_item_email" ON "claimable_item" ("email") `,
    );
  }
}
