...
export class ReputationEventEntity1649762782980 implements MigrationInterface {
  name = 'ReputationEventEntity1649762782980';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e89e9f506c292ed295dd1ec36f" ON "reputation_event" ("grantById") `,
    );
    await queryRunner.query(
