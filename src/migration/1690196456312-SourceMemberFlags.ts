...
export class SourceMemberFlags1690196456312 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_source_member_userId_flags_hideFeedPosts" ON source_member ("userId", ((flags->'hideFeedPosts')::boolean))`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_source_member_userId_flags_hideFeedPosts"`);
