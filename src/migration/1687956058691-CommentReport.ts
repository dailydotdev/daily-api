...
export class CommentReport1687956058691 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "comment_report" ("commentId" text NOT NULL, "userId" character varying(36) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "reason" character varying(12) NOT NULL, "note" text, CONSTRAINT "PK_cef0f7f862ea6ffd5a99dd640eb" PRIMARY KEY ("commentId", "userId"))`);
