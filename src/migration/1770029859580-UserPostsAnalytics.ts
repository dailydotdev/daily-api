...
export class UserPostsAnalytics1770029859580 implements MigrationInterface {
  name = 'UserPostsAnalytics1770029859580';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP MATERIALIZED VIEW IF EXISTS user_posts_analytics`);
  }
}
