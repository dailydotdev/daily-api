...
export class UserExperiences1753885628500 implements MigrationInterface {
    name = 'UserExperiences1753885628500'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_skill" ("slug" text GENERATED ALWAYS AS (trim(BOTH '-' FROM regexp_replace(lower(trim(COALESCE(LEFT(name,100),''))), '[^a-z0-9-]+', '-', 'gi'))) STORED NOT NULL, "name" text NOT NULL, "description" text, CONSTRAINT "UQ_f9ace09ebfeeccdda4802b98392" UNIQUE ("name"), CONSTRAINT "PK_41832b06c6bd9241db033c9572b" PRIMARY KEY ("slug"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_experience" ADD CONSTRAINT "FK_40370421b3ff16cb4c5074192e3" FOREIGN KEY ("educationExperienceId") REFERENCES "user_experience"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_experience_skills" DROP CONSTRAINT "FK_148b0c2faa3d2d6571c0f8f0c3b"`);
        await queryRunner.query(`ALTER TABLE "user_experience_skills" DROP CONSTRAINT "FK_81852914f77ecea988f419beb2d"`);
        await queryRunner.query(`ALTER TABLE "user_experience" DROP CONSTRAINT "FK_48330737fafe752bb82eb638b8e"`);
        await queryRunner.query(`ALTER TABLE "user_experience" DROP CONSTRAINT "FK_40370421b3ff16cb4c5074192e3"`);
        await queryRunner.query(`ALTER TABLE "user_experience" DROP CONSTRAINT "FK_fc304c1e7340f2f6dcdd1df59ce"`);
        ...
        await queryRunner.query(`DELETE FROM "public"."typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "database" = $3 AND "schema" = $4 AND "table" = $5`, ["GENERATED_COLUMN","slug","api","public","user_skill"]);
    }
